...
export function ImportDictionaryModal(props: ImportDictionaryModalProps) {
  ...
  return (
    <ModalWrapper>
      ...
      >
        {modal.content}
        <div className="modal-header">Importar Dicionário</div>
        <div className="modal-body">
          <div className="flex-column gap-10 align-center">
            <div className="flex gap-10 align-center">
              <span>Arquivo:</span>
              <input type="text" className="simple" value={selectedFile.path} />
            ...
            <If condition={!!alreadyExists}>
              <div className="flex-column gap">
                <p>
                  Já existe um dicionário com o nome "
                ...
                <If
                  condition={action === "rename"}
                    ...
                    <span>
                      As palavras que ainda não existirem serão cadastradas
                    </span>
                  }
                >
                  <div className="flex-column gap-10 align-center">
            ...
            >
              <div className="flex-column gap-10">
                ...
                <ul>
                  <li>Nome: {selectedFile.content.name}</li>
                  <li>
